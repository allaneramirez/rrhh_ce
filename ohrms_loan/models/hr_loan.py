...
class HrLoan(models.Model):
    ...
    payment_frequency = fields.Selection([
        ('mensual', 'Mensual'),
        ('quincenal', 'Quincenal'),
    ], string='Frecuencia de Pago', default='mensual',

        required=True,
        help="Frecuencia de pago del préstamo")
    ...
    period_from = fields.Integer(string="Periodo desde", default=2023)
    period_to = fields.Integer(string="Periodo hasta", default=2024)
    planilla = fields.Selection([
        ('b14', 'Bono 14'),
        ('agui', 'Aguinaldo'),
    ],  default='b14' )
    ...
    def create(self, values):
        ...
        # else:
        if not values['loan_type_id']:
            raise ValidationError(_("Debe seleccionar un tipo de préstamo."))
    ...
    def compute_installment(self):
        ...
        for loan in self:
            ...
            for i in range(1, loan.installment + 1):
                ...
                elif loan.payment_frequency == 'quincenal':
